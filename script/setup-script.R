################################################################################
# Running example MLWIC package for machine learning classification
# of remote camera trap photos.
# Aaron Greenville
################################################################################
...
# run setup if first time installing package
# setup(python_loc = "C:/ProgramData/Anaconda3", conda_loc = "auto",
#       r_reticulate = TRUE)


# Runing example
# Model trained on Nth America animals. Example provided for package
# Note don't have spaces in file paths

# classify/id animals in photos
...
# make a pretty output csv file to see results
